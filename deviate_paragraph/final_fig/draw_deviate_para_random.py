# -*- coding:utf-8 -*-
# @Time     : 2019-12-09 16:06
# @Author   : Richardo Mu
# @FILE     : draw_deviate_para_random.PY
# @Software : PyCharm
...
root = os.getcwd()
print(root)
csv_file = "E:\\debug\\pyCharmdeBug\\alignment_new_2\\deviate_paragraph_random\\csv_folder\\paradomlack-0.0_deviate-1.0.csv"
...
with open(csv_file,'r',newline='') as f:
    ...
    # 标出点
    plt.annotate('(0.74,'+str(accuracy_sw_ab_array[74])+")", xy=(0.74, accuracy_sw_ab_array[74]), xytext=(0.8, accuracy_sw_ab_array[74]+15), arrowprops=dict(facecolor='black', shrink=0.1))
    ...
    print(name[0])
    # path = root + "\\"+"实验一成段随机跑调" + ".tiff"
    path = root + "\\"+"实验一成段随机跑调" + ".eps"
