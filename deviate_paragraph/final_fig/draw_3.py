...
root = os.getcwd()
print(root)
csv_file = "E:\\debug\\pyCharmdeBug\\alignment_new_2\\deviate_paragraph\\csv_folder\\lack-0.03_deviate-1.0.csv"
...
with open(csv_file,'r',newline='') as f:
    ...
    # 设置表的字体
    plt.xlabel('The Rate of Error Notes ',fontdict={'family':'Times New Roman','size':16})
    ...
    # path = root + "\\"+"实验三成段同趋势跑调" + ".tiff"
    path = root + "\\" + "实验三成段同趋势跑调" + ".eps"
